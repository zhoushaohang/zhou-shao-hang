...
var _chunkFF26Z5MLjs = require('./chunk-FF26Z5ML.js');
...
function resolveOptions(options = {}, root = process.cwd()) {
  ...
  const resolved = _chunkFF26Z5MLjs.__spreadProps.call(void 0, _chunkFF26Z5MLjs.__spreadValues.call(void 0, {
    sourceMap: false,
    resolvedImports: {},
...
function flattenImportsMap(map, overriding = false) {
  ...
  _utils.toArray.call(void 0, map).forEach((definition) => {
    if (typeof definition === "string") {
      if (!_chunkFF26Z5MLjs.presets[definition])
        throw new Error(`[auto-import] preset ${definition} not found`);
      const preset = _chunkFF26Z5MLjs.presets[definition];
